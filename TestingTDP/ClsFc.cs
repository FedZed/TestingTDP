...
namespace TestingTDP
{
    internal class ClsFc
    {
        public class CreaTicket
        {
            ...
            {
                if (cant.ToString().Length <= 5 && precio.ToString("c").Length <= 30 && subtotal.ToString("c").Length <= 40) // valida que cant precio y total esten dentro de rango
                {
